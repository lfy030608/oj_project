...
import type { BaseResponse_CommentByIdListVO_ } from '../models/BaseResponse_CommentByIdListVO_';
...
export class CommentControllerService {
    ...
    /**
     * listCommentVOByCommentId
     * @param replyId replyId
     * @returns BaseResponse_CommentByIdListVO_ OK
     * @throws ApiError
     */
    public static listCommentVoByCommentIdUsingGet(
        replyId: number,
    ): CancelablePromise<BaseResponse_CommentByIdListVO_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/comment/list/commentId/vo',
            query: {
                'replyId': replyId,
            },
            errors: {
